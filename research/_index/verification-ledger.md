...
- **Cuboo → Verdampftnochmal (VDN Berlin GmbH, Berlin).** First-party product page verdampftnochmal.de/en/cuboo: "Cuboo is a private label of the German company Verdampftnochmal" (site meta description: "Cuboo is a brand of Verdampftnochmal"). Verdampftnochmal's official Impressum (verdampftnochmal.de/content/de/Impressum-von-Verdampftnochmal) names the legal entity **VDN Berlin GmbH, Karl-Kunger-Str 28, 12435 Berlin**. VapeFully is a **different company**: its own Terms & Conditions (vapefully.com/terms-conditions/) state the store "is operated by High Experts sp. z o.o., located at 15 Makuszyńskiego Street, 31-752 Kraków, Poland" (KRS 0000749439; VAT PL7831788419 per vapefully.com/why-vapefully/). The Cuboo export's "VapeFully House Brand" attribution was therefore an error, not a dispute; the manifest record now reads **Cuboo (Verdampftnochmal House Brand)**, `primary-sources-verified`. (The Cuboo Stick remains a documented XMAX V3 Pro rebrand.)
...
- **→ primary-sources-verified:** 17 compounds + 47 manufacturers + 3 cross-cutting subjects (cultivar-identity, evidence-architecture, manufacturer-universe), plus **Cuboo** promoted from `partially-verified` in the post-pass entity-confirmation follow-up (48 manufacturers). Errata/notes attached via queue_notes (sabinene & camphene CAS corrections; fenchol stereo note; Utillian/Firefly notes; scope notes).
- **→ partially-verified:** AroMed, Custom Log Vape Collective, Element, G-Spot, Hamilton, Smono, Sublimator, VaporBlunt, terpene-cooccurrence — brand/product claims traced, entity/parentage/attribution unresolved (documented in queue_notes).
