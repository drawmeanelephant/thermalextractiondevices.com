...
**Status:** Plan — ball-vape component-role recommendations applied 2026-08-08; Cannabis Hardware corpus completed 2026-08-08 · **Standard:** `content/reference/TREF-0004.md` (Device Architecture Taxonomy) · **Scope:** all existing `content/devices/*.md` records (43 pages, TED-0001…TED-0043) and the `devices` trunk.
