...
**Status:** Plan — ball-vape component-role recommendations applied 2026-08-08 · delivery-mode tags applied 2026-08-08 · **Standard:** `content/reference/TREF-0004.md` (Device Architecture Taxonomy) · **Scope:** all existing `content/devices/*.md` records (33 pages, TED-0001…TED-0033) and the `devices` trunk.
