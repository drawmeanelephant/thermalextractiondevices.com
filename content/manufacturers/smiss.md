---
id: manufacturers/TMFR-0016
title: "Smiss Technology Co., Ltd. (Flowermate)"
parent: manufacturers
status: published
tags: ["manufacturer", "smiss", "flowermate", "china", "shenzhen", "dry-herb"]
relations: [relates_to=devices/TED-0048]
summary: Shenzhen ODM/OEM vapor hardware manufacturer (est. 2012) whose consumer dry-herb brand is Flowermate, confirmed by a 2018 Canadian trademark-journal record.
---

# Smiss Technology Co., Ltd. (Flowermate)
...
- **Flowermate dry-herb portables (current official catalog)**: Slick, Aura, Hybrid X, Stylo, Wix, Cap / Cap Pro, V5 Nano, V5.0s Pro. [^4]
- **Flowermate V5 lineage (historical)**: V5.0, V5.0S, V5.0 Pro, V5.0S Mini / Mini Pro, V5.0X / Mini X, V5 Nano, V5.0S Pro / Pro V2. [^4]
- **SMISS ODM/OEM platform**: TempSure™ cannabis-oil platform, disposables, pods, 510 batteries (per official site). [^1]

## Engineering & Architecture

- **Primary Heating Methods**: Conduction ceramic chambers dominate the Flowermate line; the V5 Nano is marketed as hybrid (conduction/convection) with a black ceramic chamber; the Swift Pro was marketed as full convection. [^4]
- **Power Sources**: Internal lithium-ion packs on most models; the V5 Nano uses a user-replaceable 18650 (2500 mAh). [^4]
- **Airpath Wording**: Flowermate product copy uses phrases such as "fully isolated air path" and "medical grade material"; per archive convention these are reproduced as marketing claims and are not independently verified engineering facts. [^4]
...
- [Flowermate V5 Nano Dry-Herb Vaporizer](../devices/TED-0048.md)
