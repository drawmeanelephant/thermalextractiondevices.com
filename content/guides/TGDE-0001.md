...
> [!IMPORTANT]
> Neither set-point nor click temperatures are guaranteed material temperatures, and neither should be read as a "boiling point" of any specific compound. See the [Boiling Point vs Device Setting note](../includes/boiling-point-vs-device-note.md) and the [Physical Property Data Standards](../reference/TREF-0001.md).
