---
id: cultivars/TCUL-0008
title: "Strawberry Cough Cultivar Overview"
parent: cultivars
status: published
...
{{include includes/missing-batch-evidence-warning.md}}

## Genetic Identity & Origin

- **Primary Breeder**: Widely credited to Kyle Kushman; sold by Dutch Passion (breeder credit is disputed in community accounts)
- **Lineage**: Strawberry Field(s) × Haze (per widely reported accounts)
- **Classification**: Sativa-dominant hybrid
- **Common Primary Terpene Descriptors**: [β-Myrcene](../terpenes/beta-myrcene.md), [D-Limonene](../terpenes/d-limonene.md), [β-Caryophyllene](../terpenes/beta-caryophyllene.md)
...
The lineage and origin details above are breeder-attributed or community-reported claims, not independently verified genetics. Per the archive's [cultivar identity framework](../reference/cultivar-name-vs-chemovar.md), cultivar names do not fix chemical composition, and breeder-attributed pedigrees are claims that can conflict across sources.

- Dutch Passion catalog lists Strawberry Cough among its seed offerings. https://dutch-passion.com/ (accessed 2026-08-08)
- The Strawberry Fields × Haze parentage is consistent across numerous secondary and community references; no first-party breeder page stating the full pedigree was located for this archive. Breeder-credit conflict: community accounts (e.g., Overgrow) dispute the Kyle Kushman attribution. No genetic verification of the parentage was identified.
