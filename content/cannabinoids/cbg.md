...
CBG is typically a minor constituent in mature flower (acid form CBGA dominant in fresh material) and is elevated in early-flowering or Type IV (CBG-dominant) material. Values are batch- and report-attached; no universal cultivar claim is made. Consult [Lab Results](../lab-results.md) for batch-level measurements.
...
- [CBGA Record](cbga.md) (acid precursor)
- [CBD Record](cbd.md)
