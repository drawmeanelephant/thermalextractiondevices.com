---
id: jurisdictions/TJUR-0074
title: "United States (Federal Context)"
parent: jurisdictions
status: published
tags: ["jurisdiction", "united-states", "federal", "regulatory"]
relations: []
summary: "Federal cannabis context for the United States: Controlled Substances Act, the April 2026 Schedule III rescheduling of FDA-approved and state-medical products, the hemp framework, and state-law divergence."
---
...
State frameworks range from fully regulated adult-use markets (California, Colorado, Massachusetts, New York, and others) to medical-only programs to no regulated program (Idaho, Kansas, Wisconsin, and others). See the [United States state index](../jurisdictions.md#united-states) for per-state profiles. This page does not flatten state law into federal law, and no statement here is legal advice.
...
No existing repository entities are linked to the federal context page. State pages are linked from the [Jurisdictions index](../jurisdictions.md).
