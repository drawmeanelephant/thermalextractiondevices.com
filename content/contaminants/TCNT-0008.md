---
id: contaminants/TCNT-0008
title: "Residual solvents"
parent: contaminants
status: published
tags: ["contaminant", "testing", "processing"]
...
| Field | Value |
| --- | --- |
| Contaminant class | Processing chemical |
| Testing category | Required under the DCC mandatory testing panel |

## Description

Solvents remaining from extraction and processing; regulated under residual-solvent testing.
...
- **Stable entity ID**: contaminants/TCNT-0008
